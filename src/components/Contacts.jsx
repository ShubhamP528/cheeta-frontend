...
const ContactList = () => {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-b from-teal-600 to-cyan-800 dark:bg-gradient-to-b dark:from-gray-800 dark:to-gray-900 min-h-screen p-6">
      <div className="text-white font-bold text-3xl mb-6">
        <h1 className="text-white dark:text-slate-300">Contacts</h1>
      </div>
      <div className="flex-1 overflow-y-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 m-4">
          {allContact.map((contact, index) => (
            <div
              key={index}
              className="relative rounded-lg shadow-lg overflow-hidden dark:bg-gray-800 hover:shadow-xl transform hover:scale-105 transition duration-300 hover:cursor-pointer"
              onClick={() => handleContactClick(contact)}
            >
              <div className="absolute inset-0 bg-gradient-to-t from-gray-800 to-transparent opacity-50 dark:bg-gradient-to-t dark:from-black dark:to-transparent"></div>
