...
const Navbar = () => {
  ...
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const currentUser = useSelector((store) => store.user.user); // Contains name, profilePicture, etc.
  const location = useLocation();
    ...
    <nav className="bg-gradient-to-r from-teal-700 to-cyan-800 dark:from-gray-800 dark:to-gray-900 shadow-lg sticky top-0 z-50">
          ...
          <div className="hidden md:flex items-center space-x-6">
            {currentUser?.email ? (
              <>
                ...
                {/* Profile Section */}
                <div className="flex items-center space-x-4">
                  <span className="text-white font-medium dark:text-gray-300">
                  ...
                  <img
                    ...
                    alt="Profile"
                    className="w-10 h-10 rounded-full shadow-lg border-2 border-white dark:border-gray-700"
                  />
                  <button
                    onClick={handleLogout}
                    className="px-4 py-2 text-white hover:bg-teal-500 hover:text-gray-800 dark:hover:bg-gray-700 dark:hover:text-gray-300 rounded-lg shadow-md transition-all"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-teal-700 dark:bg-gray-800 relative">
            ...
            {currentUser?.email ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left text-white hover:bg-teal-500 dark:hover:bg-gray-700 dark:hover:text-gray-300 rounded-md px-3 py-2 text-base font-medium"
                >
                  Logout
                </button>
              </>
          ...
          <button
            onClick={toggleDarkMode}
            className="absolute bottom-4 right-4 text-white bg-teal-600 hover:bg-teal-500 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-full p-4 shadow-md transition-all"
          >
            {isDarkMode ? (
              <FaSun className="h-6 w-6" />
            ) : (
