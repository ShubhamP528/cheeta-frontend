...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col h-screen ">
      ...
      <div className="flex items-center justify-between bg-gradient-to-br from-teal-500 to-teal-800 dark:from-gray-800 dark:to-gray-900 text-white p-4 shadow-lg">
      ...
      <div className="flex-1 flex flex-col dark:bg-gray-900">
        ...
        <div
          className="flex-1 p-4 bg-white rounded-lg shadow-lg overflow-y-auto dark:bg-gray-900"
          style={{ maxHeight: "calc(100vh - 20vh)" }}
        >
          <div className="space-y-4">
            {groupedMsg.map((group, index) => (
              <div key={index}>
                <div className="text-center text-sm text-gray-500 py-2 dark:text-gray-300">
                  {group.date}
                </div>
                    ...
                    <div
                      className={`message-bubble ${
                        message.from === currentUser.username
                          ...
                          : "message-bubble-receiver dark:bg-gray-700 dark:text-gray-300"
                      }`}
                    >
        ...
        {/* Message Input */}
        <div className="p-4 bg-white border-t border-gray-200 flex items-center dark:bg-gray-800">
          <button
          ...
          />
          <button
            className="ml-2 p-2 bg-teal-600 text-white rounded-md hover:bg-blue-700 transition"
        ...
        {showEmojiPicker && (
          <div
            ...
            className={`absolute bottom-20 right-6 z-10 
             dark:bg-gray-800 dark:text-white bg-white text-black rounded-lg p-2 shadow-lg`}
          >
